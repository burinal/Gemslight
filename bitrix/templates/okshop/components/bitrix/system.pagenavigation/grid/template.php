...
<?
	if ($arResult["NavPageNomer"] < $arResult["NavPageCount"]):
		if($arResult["bSavePage"]):
?>
			<a class="main-ui-pagination-arrow main-ui-pagination-prev" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]+1)?>"><i class="fa fa-angle-double-left" aria-hidden="true"></i> <?=GetMessage("MAIN_UI_PAGINATION__PREV")?></a>
<?
		else:
			if ($arResult["NavPageCount"] == ($arResult["NavPageNomer"]+1) ):
?>
				<a class="main-ui-pagination-arrow main-ui-pagination-prev" href="<?=$arResult["sUrlPath"]?><?=$strNavQueryStringFull?>">
				<i class="fa fa-angle-double-left" aria-hidden="true"></i> <?=GetMessage("MAIN_UI_PAGINATION__PREV")?></a>
<?
			else:
?>
				<a class="main-ui-pagination-arrow main-ui-pagination-prev" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]+1)?>">
				<i class="fa fa-angle-double-left" aria-hidden="true"></i> <?=GetMessage("MAIN_UI_PAGINATION__PREV")?></a>
<?
			endif;
		endif;
...
?>
		<span class="main-ui-pagination-arrow main-ui-pagination-prev"><i class="fa fa-angle-double-left" aria-hidden="true"></i> <?=GetMessage("MAIN_UI_PAGINATION__PREV")?></span>
<?
	endif;
...
<? if ($arResult["NavPageNomer"] > 1):
        ...
        <? else:
			...
			<a class="main-ui-pagination-arrow main-ui-pagination-prev" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]-1)?>"><i class="fa fa-angle-double-left" aria-hidden="true"></i> <?=GetMessage("MAIN_UI_PAGINATION__PREV")?></a>
        <? else: ?>
            <a class="main-ui-pagination-arrow main-ui-pagination-prev" href="<?=$arResult["sUrlPath"]?><?=$strNavQueryStringFull?>"><i class="fa fa-angle-double-left" aria-hidden="true"></i> <?=GetMessage("MAIN_UI_PAGINATION__PREV")?></a>
        <? endif;
        endif;
        else: ?>
		<span class="main-ui-pagination-arrow main-ui-pagination-prev"><i class="fa fa-angle-double-left" aria-hidden="true"></i> <?=GetMessage("MAIN_UI_PAGINATION__PREV")?></span>
...
<?
	...
	if($arResult["NavPageNomer"] < $arResult["NavPageCount"]):
?>
		<a class="main-ui-pagination-arrow main-ui-pagination-next" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]+1)?>"><?=GetMessage("MAIN_UI_PAGINATION__NEXT")?> <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
<?
	else:
?>
		<span class="main-ui-pagination-arrow main-ui-pagination-next"><?=GetMessage("MAIN_UI_PAGINATION__NEXT")?> <i class="fa fa-angle-double-right" aria-hidden="true"></i></span>
<?
	endif;
?>
	</div>
