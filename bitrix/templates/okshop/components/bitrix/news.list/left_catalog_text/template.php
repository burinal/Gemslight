...
?>
<section class="left_catalog_text section block-card-section block-card-overlap bg-image-section-four reveal q_active">
    <div class="q-container container-inner">
        ...
        <div class="columns overlap-wrapper type-1">
            ...
            <div class="column block-picture">
                <figure class="picture" style="height: 556px;">
